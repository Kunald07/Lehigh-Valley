function tiltJs() {
    var VanillaTilt = (function () {
      ...
      /**
       * Created by Kunal Deshmukh  on 16/07/2024.
       * MIT License.
       * Version 1.8.1
       */
  ...
  var img = document.querySelector(".page2-img > img");
  ...
  var sameImg = document.querySelectorAll(".sameimg");
  var same = document.querySelectorAll(".same");
  
  same.forEach((elem, index) => {
    elem.addEventListener("mouseenter", () => {
      sameImg[index].classList.add("scaled");
      elem.style.opacity = 1;
    });
  
    elem.addEventListener("mouseleave", () => {
      sameImg[index].classList.remove("scaled");
      elem.style.opacity = 0;
    });
  });
  
  var videoOverlay = document.querySelector(".page3-video-overlay");
  ...
  t1.from(".main-heading > h1", { opacity: 0, y: 50, delay: 0.5 })
    ...
    .from([".page2>.page2-left", ".page2>.page2-right"], {
      opacity: 0,
      stagger: 0.5,
      scrollTrigger: {
        scroller: "body",
    ...
    .from([".page3-left-img1", ".page3-right-video"], {
      opacity: 0,
      stagger: 0.5,
      scrollTrigger: {
        scroller: "body",
